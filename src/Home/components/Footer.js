...
const Footer = () => {
  return (
    <footer class="dorik-section dorik-section-x40k6yqg ">
      <div class="container">
          ...
          <div class="col-lg-1/3 col-md-1/3 ">
            <div class="column-inner dorik-column-b7upwuf2  1/3">
              <div class="dorik-text dorik-text-k2xzpsrw ">
                Copyright (c) 2023 SmartPay. LLC.
              </div>
            </div>
          </div>
          <div class="col-lg-1/3 col-md-1/3 ">
            <div class="column-inner dorik-column-shlawi44  1/3">
              <ul class="dorik-socialIcon-0xcislfz  dorik-socialIcon-0xcislfz-wrapper ">
                <li>
